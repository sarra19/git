...
v->text=TTF_OpenFont("SIXTY.TTF",66);
...
v->image_vie[0]=IMG_Load("h0.png");
v->image_vie[1]=IMG_Load("h1.png");
v->image_vie[2]=IMG_Load("h2.png");
v->image_vie[3]=IMG_Load("h3.png");


//positions


v->position_vie.x = 130;
v->position_vie.y = 0;
v->val=3;
TTF_CloseFont(text);
}
